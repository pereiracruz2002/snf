...
<html lang="pt">
  <head>
    ...
    <link href="<?php echo base_url() ?>assets/css/plugins/morris.css" rel="stylesheet">
     <link href="<?php echo base_url() ?>assets/fontsfont-awesome-4.1.0/css/font-awesome.min.css" rel="stylesheet">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <?php if($this->session->userdata('tipo')=="admin"):?>
                     <li>
                        <a href="<?php echo base_url() ?>empresas"><i class="fa fa-fw fa-bar-chart-o"></i> Gerenciar Empresas</a>
                    </li>
                     <li>
