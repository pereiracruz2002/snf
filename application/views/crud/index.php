                        ...
                        <tr>
                            ...
                            <td class="acoes">
                                ...
                                <?php foreach ($acoes_extras as $acao_extra): ?>
                                    <a class="btn btn-xs btn-info btn btn-danger" onclick="janelaEditarCliente(<?= $row->{$model->id_col}; ?>)"  href="javascript:" class="btn btn-xs <?= $acao_extra['class']; ?>"><?= $acao_extra['title']; ?></a>
                                <?php endforeach; ?>
                            </td>
                        </tr>
                        <?php endforeach ?>
